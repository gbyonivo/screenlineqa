...
import { goToCreateTeacherPage, locators as teacherLocators } from '../../pages/teacher';
...
context('Create teacher', async () => {
  it('Successfully create a tertiary teacher', async () => {
